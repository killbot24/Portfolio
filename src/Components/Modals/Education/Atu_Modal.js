...
function Atu_Modal() { 
 ...
 return (
    ...
    <button data-modal-target="defaultModal" data-modal-toggle="defaultModal" className='bg-blue-500 hover:bg-blue-400 text-white font-bold  px-1 float-right border-b-4 border-blue-700 hover:border-blue-500 rounded' type="button">
      Show More
    </button>
        ...
        <div class="relative w-full h-full max-w-2xl md:h-auto">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="flex items-start justify-between p-4 border-b rounded-t dark:border-gray-600">
                    ...
                    Digital media and computeing (Honors) At GMIT/ATU
                    </h3>
...
export default Atu_Modal // Don�t forget to use export default!