...
function Breakit_Modal() { 
 ...
 return (
    ...
    <button data-modal-target="BreakitModal" data-modal-toggle="BreakitModal" className=' text-white font-bold py-2 px-4 hover:bg-slate-500  border-b-4 rounded' type="button">
      Show More
    </button>
