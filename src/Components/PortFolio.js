        ...
        <div id='Portfolio' class="Portfolio ">
            ...
            <div class=" w-full lg:w-3/4 mx-auto">
                <div className='pb-5 grid grid-rows-3 grid-flow-col   gap-1 mt-2 mx-auto'>
                    ...
                    <div class="bg-gray-800   py-2 px-2 text-center flex flex-col">
                        <h1 className=' font-bold text-white text-2xl'>Shop app</h1>
                    ...
                    <div class="bg-gray-800   py-2 px-2 text-center flex flex-col">
                        <h1 className=' font-bold text-white text-2xl'>MetaEvil</h1>
                    ...
                    <div class="bg-gray-800   py-2 px-2 text-center flex flex-col">
                        <h1 className=' font-bold text-white text-2xl'>Breakit</h1>
                    ...
                    <div class="bg-gray-800   py-2 px-2 text-center flex flex-col">
                        <h1 className=' font-bold text-white text-2xl'>Unamed Game</h1>
                    ...
                    <div class="bg-gray-800   py-2 px-2 text-center flex flex-col">
                        <h1 className=' font-bold text-white text-2xl'>Chatfilter</h1>
