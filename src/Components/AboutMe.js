...
function AboutMe() {
    ...
    return (
        ...
        <div id='AboutMe' class="Aboutme bg-gray-800 ">
            <h1 class="capitalize text-center font-bold text-white text-5xl">About me</h1>
            ...
            <h1 class="text-center font-bold text-white text-5xl">Skills</h1>
